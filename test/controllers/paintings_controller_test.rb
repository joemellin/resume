...
class PaintingsControllerTest < ActionController::TestCase
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post :create, painting: { current: @painting.current, dimension: @painting.dimension, exhibition: @painting.exhibition, inventory: @painting.inventory, medium: @painting.medium, title: @painting.title, year: @painting.year }
    end
  ...
  test "should update painting" do
    patch :update, id: @painting, painting: { current: @painting.current, dimension: @painting.dimension, exhibition: @painting.exhibition, inventory: @painting.inventory, medium: @painting.medium, title: @painting.title, year: @painting.year }
    assert_redirected_to painting_path(assigns(:painting))
  end
